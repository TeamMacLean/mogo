...
all_mo_genes <- function(genefile=here::here("inst", "extdata", "all_mo_ids.csv")){
...
mo_mapping <- function(termsfile=here::here("inst", "extdata", "MG8_mart_export.txt")) {
...
#' @export
do_enrich <- function(genes, termsfile=here::here("inst", "extdata", "MG8_mart_export.txt"), ...) {
  info <- mo_mapping(termsfile)
...
#' @export
enricher_to_david <- function(enrich,termsfile=here::here("inst","extdata", "MG8_mart_export.txt")){
